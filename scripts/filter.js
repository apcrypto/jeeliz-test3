...
function init_threeScene(spec) {
  ...
  const threeFaceFollowers = extract_threeChildrenWithId(
    "jeelizFaceFilterFollow",
    THREESCENE
  );
  if (!threeFaceFollowers || !threeFaceFollowers.length) {
    alert(
      "No element with id = jeelizFaceFilterFollow has been found in the A-Frame scene. You should have at least one. Otherwise none of your stuffs will follow the head"
    );
  } else {
